...
class RegisterandrecoverController extends ControllerBaseOut
{
    ...
    public function changepasswordAction()
    {
        ...
        if (count($arrEmail) == 2 && $dominio == "viasbolivia.gob.bo") {
            ...
            $ruta = 'http://localhost:8010/registerandrecover/definepassword/';
            if (is_object($param)) {
                    ...
                    if ($oku) {
                        ...
                        if ($idRelaboralSolicitante > 0) {
                            ...
                            if ($userMail != '' && $passMail != '' && $hostMail != '' && $portMail != '') {
                                ...
                                } else $msj = array('result' => 0, 'msj' => 'No se ha podido enviar el correo electr&oacute;nico, cont&aacute;ctese con personal de Recursos Humanos  X1.');
                            }
                        }
    ...
    public function recoverAction()
    {
        ...
        if (count($arrEmail) == 2 && $dominio == "viasbolivia.gob.bo") {
            $param = Parametros::findFirst(array("parametro LIKE 'RUTA_APLICACION' AND estado=1 AND baja_logica=1"));
            /*$ruta1 = 'http://rrhh.local/registerandrecover/solredefinepassword/';*/
            $ruta = 'http://localhost:8010/registerandrecover/solredefinepassword/';
            echo "Esto es {$ruta['valor']} !";
            if (is_object($param)) {
                    ...
                    if ($oku) {
                        ...
                        if ($idRelaboralSolicitante > 0) {
                            ...
                            if ($userMail != '' && $passMail != '' && $hostMail != '' && $portMail != '') {
                                ...
                                if ($mail->Send()) {
                                    $msj = array('result' => 1, 'msj' => 'Exito! Se envi&oacute; un mensaje de correo electr&oacute;nico de confirmaci&oacute;n a su cuenta, revise su Bandeja de Entrada.');
                                } else $msj = array('result' => 0, 'msj' => 'No se ha podido enviar el correo electr&oacute;nico, cont&aacute;ctese con personal de Recursos Humanos  X2.');
