...
function exportarReporte(option){
    ...
    ubicacion = $('#divGridTiposDocumentos').jqxGrid('getcolumn','ubicacion');
    condicion = $('#divGridTiposDocumentos').jqxGrid('getcolumn','condicion');
    estado_descripcion = $('#divGridTiposDocumentos').jqxGrid('getcolumn','estado_descripcion');
    nombres = $('#divGridTiposDocumentos').jqxGrid('getcolumn','nombres');
    ci = $('#divGridTiposDocumentos').jqxGrid('getcolumn','ci');
    expd = $('#divGridTiposDocumentos').jqxGrid('getcolumn','expd');
    /*num_complemento = $('#divGridTiposDocumentos').jqxGrid('getcolumn','num_complemento');*/
    gerencia_administrativa = $('#divGridTiposDocumentos').jqxGrid('getcolumn','gerencia_administrativa');
    cargo = $('#divGridTiposDocumentos').jqxGrid('getcolumn','cargo');
    sueldo = $('#divGridTiposDocumentos').jqxGrid('getcolumn','sueldo');
    departamento_administrativo = $('#divGridTiposDocumentos').jqxGrid('getcolumn','departamento_administrativo');
    area = $('#divGridTiposDocumentos').jqxGrid('getcolumn','area');
    fin_partida = $('#divGridTiposDocumentos').jqxGrid('getcolumn','fin_partida');
    proceso_codigo = $('#divGridTiposDocumentos').jqxGrid('getcolumn','proceso_codigo');
    nivelsalarial = $('#divGridTiposDocumentos').jqxGrid('getcolumn','nivelsalarial');
    fecha_ini = $('#divGridTiposDocumentos').jqxGrid('getcolumn','fecha_ini');
    fecha_incor = $('#divGridTiposDocumentos').jqxGrid('getcolumn','fecha_incor');
    fecha_fin = $('#divGridTiposDocumentos').jqxGrid('getcolumn','fecha_fin'),
    fecha_baja = $('#divGridTiposDocumentos').jqxGrid('getcolumn','fecha_baja');
    motivo_baja = $('#divGridTiposDocumentos').jqxGrid('getcolumn','motivo_baja');
    observacion = $('#divGridTiposDocumentos').jqxGrid('getcolumn','observacion');
    ...
    var groups = $('#divGridTiposDocumentos').jqxGrid('groups');
    if(groups==null||groups=='')groups='null';
    //var sorteds = $('#divGridTiposDocumentos').jqxGrid('getsortcolumn');

    var sortinformation = $('#divGridTiposDocumentos').jqxGrid('getsortinformation');
    ...
    var rows = $('#divGridTiposDocumentos').jqxGrid('getrows');
    var filterGroups = $('#divGridTiposDocumentos').jqxGrid('getfilterinformation');
    var counter = 0;
